...
class _SkillListPageState extends State<SkillListPage> {
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      Text(
                         "${((skill['targetHours'] ?? 10) * 60) - totalMinutes} min to master",
                        style: const TextStyle(
                    ...
                    TextButton.icon(
                      onPressed: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_) {
                              final syllabus = skill['syllabus'] as List<dynamic>? ?? [];
                              final firstTopic = syllabus.isNotEmpty ? syllabus.first['topic'] : 'General Review';
                              final targetHours = skill['targetHours'] ?? 10;
                              final totalMinutes = skill['totalMinutes'] ?? 0;
                              ...
                              return QuizPage(
                                ...
                                totalHours: targetHours > 0 ? targetHours : 10,
                                practiceMinutes: 0,
                                practiceNote: null,
                                resourceLinks: const [],
                              );
  ...
  Widget _buildTotalProgressionCard(int totalCompletedHours, int totalTargetHours) {
