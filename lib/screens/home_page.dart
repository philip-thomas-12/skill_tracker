              ...
              children: [
                          ...
                          children: [
                            ...
                            Center(
                              child: CircularPercentIndicator(
                                radius: 55.0,
                                lineWidth: 10.0,
                                percent: (data['progress']?.toDouble() ?? 0.79)
                                    .clamp(0.0, 1.0),
                                center: Text(
                                  "${((data['progress'] ?? 0.79) * 100).toInt()}%",
                ...
                _card(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      const Text("Skill Log Timeline",
                          style: TextStyle(color: Colors.white38, fontSize: 12)),
                      const SizedBox(height: 15),
                      _timelineItem(
                          const Color(0xFFE67E22), "1h UI/UX Design", "From Scratch", "11:00"),
                      _timelineItem(
                          const Color(0xFF2ECC71), "30 min Coding", "Challenge", "14:00"),
                    ],
                  ),
                ),
              ],
